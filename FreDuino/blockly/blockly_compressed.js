    ...
    for (f = b = 0; (g = d[f]); f++)
      (e = g.className),
        "function" == typeof e.split &&
          goog.array.contains(e.split(/\s+/), c) &&
          (a[b++] = g);
    a.length = b;
    return a;
  }
...
goog.style.installSafeStyleSheet = function (a, b) {
  ...
  if (goog.userAgent.IE && d.createStyleSheet) {
    ...
    (d = c.getElementsByTagNameAndClass("HEAD")[0]),
      d ||
        ((e = c.getElementsByTagNameAndClass("BODY")[0]),
        (d = c.createDom("HEAD")),
    ...
    if (
      ...
      if (!goog.events.isMarkedIeEvent_(d)) {
        ...
        for (g = 0; !e.propagationStopped_ && g < d.length; g++)
          (e.currentTarget = d[g]),
            (h = goog.events.fireListeners_(d[g], c, !1, e)),
            (f = f && h);
      }
...
goog.structs.Map.prototype.cleanupKeysArray_ = function () {
  ...
  if (this.count_ != this.keys_.length) {
    ...
    for (a = b = 0; b < this.keys_.length; )
      (c = this.keys_[b]),
        goog.structs.Map.hasKey_(d, c) || ((this.keys_[a++] = c), (d[c] = 1)),
        b++;
    this.keys_.length = a;
  }
};
  ...
  if ((c = c || goog.cssom.getParentStyleSheet(a)))
    if (
      ((a =
        0 <= Number(d)
          ? Number(d)
          : goog.cssom.getCssRuleIndexInParentStyleSheet(a, c)),
      0 <= a)
    )
...
goog.cssom.addCssText = function (a, b) {
  ...
  e.styleSheet
    ...
    : ((c = d.createTextNode(a)), e.appendChild(c));
  return e;
};
...
goog.cssom.getAllCss_ = function (a, b) {
  for (
    ...
    if (f && f.length)
      for (var g = 0, h = 0, k = f.length, m; h < k; h++)
        (m = f[h]),
          b && !m.href
            ? ((m = goog.cssom.getCssTextFromCssRule(m)), c.push(m))
            : m.href ||
              (m.style &&
                (m.parentStyleSheet ||
                  (m.style["-closure-parent-stylesheet"] = a),
                (m.style["-closure-rule-index"] = b ? void 0 : g)),
              c.push(m)),
          b || g++;
  }
  return b ? c.join(" ") : c;
...
Blockly.Connection.prototype.connect = function (a) {
  ...
  if (this.type == Blockly.INPUT_VALUE || this.type == Blockly.OUTPUT_VALUE) {
    ...
    if (a.targetConnection) {
      var c = a.targetBlock();
      c.setParent(null);
      if (!c.outputConnection)
        throw "Orphan block does not have an output connection.";
      for (
        b = this.sourceBlock_;
        (b = Blockly.Connection.singleConnection_(b, c));

      )
        if (b.targetBlock()) b = b.targetBlock();
        else {
    ...
    if (a.targetConnection) {
      ...
      c = a.targetBlock();
      c.setParent(null);
      if (!c.previousConnection)
        throw "Orphan block does not have a previous connection.";
      for (b = this.sourceBlock_; b.nextConnection; )
        if (b.nextConnection.targetConnection) b = b.getNextBlock();
        else {
          c.previousConnection.checkType_(b.nextConnection) &&
            (b.nextConnection.connect(c.previousConnection), (c = null));
          break;
        }
      c &&
        setTimeout(function () {
  ...
  } else (b = a.sourceBlock_), (d = this.sourceBlock_);
...
Blockly.Tooltip.onMouseMove_ = function (a) {
  Blockly.Tooltip.element_ &&
    ...
    (Blockly.Tooltip.visible
      ? Math.sqrt(
          Math.pow(Blockly.Tooltip.lastX_ - a.clientX, 2) +
            Math.pow(Blockly.Tooltip.lastY_ - a.clientY, 2)
...
Blockly.Tooltip.wrap_ = function (a, b) {
  ...
  do {
    var f = d;
    var g = a;
    for (var h = [], k = c.length / e, m = 1, d = 0; d < c.length - 1; d++)
...
Blockly.Scrollbar.prototype.resize = function (a) {
  var b = a;
  if (!b && ((b = this.workspace_.getMetrics()), !b)) return;
  if (this.horizontal_) {
    var c = b.viewWidth - 1;
    this.pair_
      ? (c -= Blockly.Scrollbar.scrollbarThickness)
      : this.setVisible(c < b.contentHeight);
    this.ratio_ = c / b.contentWidth;
    if (
      ...
      this.ratio_ = 0;
    var d = b.viewWidth * this.ratio_;
    a = (b.viewLeft - b.contentLeft) * this.ratio_;
    this.svgKnob_.setAttribute("width", Math.max(0, d));
    this.xCoordinate = b.absoluteLeft + 0.5;
    this.pair_ &&
      this.workspace_.RTL &&
      (this.xCoordinate +=
        b.absoluteLeft + Blockly.Scrollbar.scrollbarThickness);
    this.yCoordinate =
      b.absoluteTop + b.viewHeight - Blockly.Scrollbar.scrollbarThickness - 0.5;
    this.svgGroup_.setAttribute(
      "transform",
      "translate(" + this.xCoordinate + ", " + this.yCoordinate + ")"
    );
    this.svgBackground_.setAttribute("width", Math.max(0, c));
    this.svgKnob_.setAttribute("x", this.constrainKnob_(a));
  } else {
    c = b.viewHeight - 1;
    this.pair_
      ? (c -= Blockly.Scrollbar.scrollbarThickness)
      : this.setVisible(c < b.contentHeight);
    this.ratio_ = c / b.contentHeight;
    if (
      -Infinity === this.ratio_ ||
      Infinity === this.ratio_ ||
      isNaN(this.ratio_)
      ...
      this.ratio_ = 0;
    d = b.viewHeight * this.ratio_;
    a = (b.viewTop - b.contentTop) * this.ratio_;
    this.svgKnob_.setAttribute("height", Math.max(0, d));
    this.xCoordinate = b.absoluteLeft + 0.5;
    this.workspace_.RTL ||
      (this.xCoordinate +=
        b.viewWidth - Blockly.Scrollbar.scrollbarThickness - 1);
    this.yCoordinate = b.absoluteTop + 0.5;
    this.svgGroup_.setAttribute(
      "transform",
      "translate(" + this.xCoordinate + ", " + this.yCoordinate + ")"
    );
    this.svgBackground_.setAttribute("height", Math.max(0, c));
    this.svgKnob_.setAttribute("y", this.constrainKnob_(a));
  }
  this.onScroll_();
};
...
Blockly.Xml.blockToDom_ = function (a) {
  ...
  for (d = 0; (e = a.inputList[d]); d++)
    (f = !0),
      e.type != Blockly.DUMMY_INPUT &&
        ((g = e.connection.targetBlock()),
        e.type == Blockly.INPUT_VALUE
          ? (b = goog.dom.createDom("value"))
          : e.type == Blockly.NEXT_STATEMENT &&
            (b = goog.dom.createDom("statement")),
        g && (b.appendChild(Blockly.Xml.blockToDom_(g)), (f = !1)),
  ...
  if ((a = a.getNextBlock()))
    (b = goog.dom.createDom("next", null, Blockly.Xml.blockToDom_(a))),
      c.appendChild(b);
  return c;
};
...
Blockly.Xml.domToBlockHeadless_ = function (a, b, c) {
  ...
  for (var g = null, f = 0, h; (h = b.childNodes[f]); f++)
    if (3 != h.nodeType || !h.data.match(/^\s*$/)) {
      for (var g = null, k = 0, m; (m = h.childNodes[k]); k++)
        (3 == m.nodeType && m.data.match(/^\s*$/)) || (g = m);
      ...
      do {
        ...
        for (var e = this.getAllBlocks(), f = 0, g; (g = e[f]); f++)
          if (
            ...
            1 >= Math.abs(c - g.x) && 1 >= Math.abs(d - g.y))
          ) {
            a = !0;
            break;
          }
        if (!a)
          for (e = b.getConnections_(!1), f = 0; (g = e[f]); f++)
            if (g.closest(Blockly.SNAP_RADIUS, c, d).connection) {
              a = !0;
              break;
            }
        a &&
...
Blockly.Mutator.prototype.resizeBubble_ = function () {
  ...
  var d = this.block_.RTL ? -b.x : b.width + b.x;
...
Blockly.Block.prototype.getSurroundParent = function () {
  for (var a, b = this; ; ) {
    do if (((a = b), (b = b.getParent()), !b)) return null;
    while (b.getNextBlock() == a);
    return b;
  }
};
  ...
  if (!a && this.isCollapsed())
    this.outputConnection && this.outputConnection.setHidden(a),
      ...
      this.nextConnection &&
        ...
        (b = this.nextConnection.targetBlock()) && b.setConnectionsHidden(a));
  else
...
Blockly.Block.prototype.interpolate_ = function (a, b, c) {
  ...
  for (g = 0; g < a.length; g++)
    if (((f = a[g]), "string" == typeof f)) d.push([f, void 0]);
    else {
      b = h = null;
      do
        switch (((e = !1), f.type)) {
          case "input_value":
            b = this.appendValueInput(f.name);
            break;
          case "input_statement":
            b = this.appendStatementInput(f.name);
            break;
          case "input_dummy":
            b = this.appendDummyInput(f.name);
            break;
          case "field_label":
      ...
      while (e);
      if (h) d.push([h, f.name]);
      else if (b) {
        f.check && b.setCheck(f.check);
        f.align && b.setAlign(c[f.align]);
    ...
    if (
      ...
      if (2 == Blockly.dragMode_) {
        ...
        for (
          ...
          var m = f[e],
            n = m.closest(k, c, d);
          n.connection && ((g = n.connection), (h = m), (k = n.radius));
        }
        Blockly.highlightedConnection_ &&
    ...
    if (l.isVisible()) {
      ...
      l.renderWidth =
        m && l.type == Blockly.INPUT_VALUE
          ...
          : 0;
      if (l.connection && l.connection.targetConnection) {
        var r = l.connection.targetBlock().getHeightWidth();
        l.renderHeight = Math.max(l.renderHeight, r.height);
        l.renderWidth = Math.max(l.renderWidth, r.width);
      }
      m || n != b.length - 1
        ? !m &&
      ...
      for (var r = !1, q = 0, t; (t = l.fieldRow[q]); q++) {
        0 != q && (l.fieldWidth += Blockly.BlockSvg.SEP_SPACE_X);
        var u = t.getSize();
...
Blockly.BlockSvg.prototype.renderDrawRight_ = function (a, b, c, d, e, f, g) {
  for (var h, k, m, n, l = 0, p, r = 0, q; (q = f[r]); r++) {
    k = Blockly.BlockSvg.SEP_SPACE_X;
    0 == r && (k += this.RTL ? -g : g);
    b.push("M", f.rightEdge - 0.5 + "," + (l + 0.5));
    if (this.isCollapsed())
      (n = q[0]),
        (m = k),
        (k = l + Blockly.BlockSvg.FIELD_HEIGHT),
        this.renderFields_(n.fieldRow, m, k),
      ...
      for (h = 0; (n = q[h]); h++)
        (m = k),
          (k = l + Blockly.BlockSvg.FIELD_HEIGHT),
          q.thicker && (k += Blockly.BlockSvg.INLINE_PADDING_Y),
          (k = this.renderFields_(n.fieldRow, m, k)),
          n.type != Blockly.DUMMY_INPUT &&
            (k += n.renderWidth + Blockly.BlockSvg.SEP_SPACE_X),
          n.type == Blockly.INPUT_VALUE &&
            ...
            this.RTL
              ? (d.push(
                  ...
                  k -
                    ...
                    n.renderWidth +
                    "," +
                    (l + Blockly.BlockSvg.INLINE_PADDING_Y + 0.5)
                ),
            ...
            (m = this.RTL
              ...
              : e.x +
                ...
                n.renderWidth -
                1),
            (p = e.y + l + Blockly.BlockSvg.INLINE_PADDING_Y + 1),
            n.connection.moveTo(m, p),
            n.connection.targetConnection && n.connection.tighten_());
      k = Math.max(k, f.rightEdge);
      this.width = Math.max(this.width, k);
      a.push("H", k);
      b.push("H", k - 0.5);
      a.push("v", q.height);
      ...
      q.type == Blockly.INPUT_VALUE
        ? ((n = q[0]),
          ...
          n.align != Blockly.ALIGN_LEFT &&
            ...
            n.align == Blockly.ALIGN_RIGHT
              ? (m += h)
              : n.align == Blockly.ALIGN_CENTRE && (m += (h + m) / 2)),
          this.renderFields_(n.fieldRow, m, k),
          a.push(Blockly.BlockSvg.TAB_PATH_DOWN),
          (h = q.height - Blockly.BlockSvg.TAB_HEIGHT),
          a.push("v", h),
          this.RTL
            ...
            : (b.push(
                "M",
                f.rightEdge - 5 + "," + (l + Blockly.BlockSvg.TAB_HEIGHT - 0.7)
              ),
              b.push("l", 0.46 * Blockly.BlockSvg.TAB_WIDTH + ",-2.1")),
          (m = e.x + (this.RTL ? -f.rightEdge - 1 : f.rightEdge + 1)),
          (p = e.y + l),
          n.connection.moveTo(m, p),
        ...
        ? ((n = q[0]),
          ...
          n.align != Blockly.ALIGN_LEFT &&
            ...
            f.hasValue && (h -= Blockly.BlockSvg.TAB_WIDTH),
            n.align == Blockly.ALIGN_RIGHT
              ? (m += h)
              : n.align == Blockly.ALIGN_CENTRE && (m += (h + m) / 2)),
          this.renderFields_(n.fieldRow, m, k),
        ...
        : q.type == Blockly.NEXT_STATEMENT &&
          ...
          n.align != Blockly.ALIGN_LEFT &&
            ...
            n.align == Blockly.ALIGN_RIGHT
              ...
              : n.align == Blockly.ALIGN_CENTRE && (m += (h + m) / 2)),
          this.renderFields_(n.fieldRow, m, k),
          (k = f.statementEdge + Blockly.BlockSvg.NOTCH_WIDTH),
          a.push("H", k),
          a.push(Blockly.BlockSvg.INNER_TOP_LEFT_CORNER),
          a.push("v", q.height - 2 * Blockly.BlockSvg.CORNER_RADIUS),
          ...
          this.RTL
            ? (b.push(
                ...
                k -
                  ...
                  Blockly.BlockSvg.DISTANCE_45_OUTSIDE +
                  "," +
                  (l + Blockly.BlockSvg.DISTANCE_45_OUTSIDE)
              ),
              b.push(Blockly.BlockSvg.INNER_TOP_LEFT_CORNER_HIGHLIGHT_RTL),
              b.push("v", q.height - 2 * Blockly.BlockSvg.CORNER_RADIUS),
          ...
          r == f.length - 1 || f[r + 1].type == Blockly.NEXT_STATEMENT) &&
          (a.push("v", Blockly.BlockSvg.SEP_SPACE_Y),
          this.RTL && b.push("v", Blockly.BlockSvg.SEP_SPACE_Y - 1),
          (l += Blockly.BlockSvg.SEP_SPACE_Y));
    l += q.height;
  ...
  f.length ||
    ((l = Blockly.BlockSvg.MIN_BLOCK_Y),
    a.push("V", l),
    this.RTL && b.push("V", l - 1));
  return l;
};
  ...
  if (a) {
    ...
    var c = function (c) {
      ...
      if (null === d) var f = d;
        ...
        void 0 === d && (d = c),
          (f = Blockly.FieldAngle.angleValidator.call(b, d)),
          void 0 !== f && (f = d);
      return f === c ? void 0 : f;
    };
  } else c = Blockly.FieldAngle.angleValidator;
  Blockly.FieldAngle.superClass_.setChangeHandler(c);
};
  ...
  if (a) {
    ...
    var c = function (c) {
      ...
      if (null === d) var f = d;
        ...
        void 0 === d && (d = c),
          (f = Blockly.FieldVariable.dropdownChange.call(b, d)),
          void 0 !== f && (f = d);
      return f === c ? void 0 : f;
    };
  } else c = Blockly.FieldVariable.dropdownChange;
  Blockly.FieldVariable.superClass_.setChangeHandler(c);
};
Blockly.FieldVariable.prototype.init = function (a) {
  if (!this.sourceBlock_) {
    if (!this.getValue()) {
      var b = a.isInFlyout ? a.workspace.targetWorkspace : a.workspace;
      this.setValue(Blockly.Variables.generateUniqueName(b));
    }
...
Blockly.Procedures.flyoutCategory = function (a, b, c, d) {
  function e(e, f) {
    for (var g = 0; g < e.length; g++) {
      var h = Blockly.Block.obtain(d, f);
      h.setFieldValue(e[g][0], "NAME");
      for (var n = [], l = 0; l < e[g][1].length; l++) n[l] = "ARG" + l;
      h.setProcedureParameters(e[g][1], n);
      h.initSvg();
      a.push(h);
      b.push(2 * c);
    }
  ...
  function f() {
    function a(a) {
      gapi.client.drive.properties
        .insert({
          fileId: "appdata",
          resource: { key: rtclient.FOLDER_KEY, value: a },
        })
        .execute(function (b) {
          e(a);
        });
...
Blockly.Flyout.prototype.show = function (a) {
  ...
  for (c = 0; (b = this.buttons_[c]); c++) goog.dom.removeNode(b);
  ...
  if (a == Blockly.Variables.NAME_TYPE)
    Blockly.Variables.flyoutCategory(e, g, f, this.workspace_);
  else if (a == Blockly.Procedures.NAME_TYPE)
    Blockly.Procedures.flyoutCategory(e, g, f, this.workspace_);
  else
    for (var h = 0; (d = a[h]); h++)
      d.tagName &&
  ...
  for (h = 0; (d = e[h]); h++) {
    c = d.getDescendants();
    b = 0;
    for (var k; (k = c[b]); b++) (k.isInFlyout = !0), k.setCommentText(null);
    d.render();
    k = d.getSvgRoot();
    b = d.getHeightWidth();
    ...
    d.moveBy(c, a);
    a += b.height + g[h];
    b = Blockly.createSvgElement("rect", { "fill-opacity": 0 }, null);
    this.workspace_.getCanvas().insertBefore(b, d.getSvgRoot());
    d.flyoutRect_ = b;
    this.buttons_[h] = b;
    this.autoClose
    ...
    this.listeners_.push(
      Blockly.bindEvent_(b, "mousedown", null, this.createBlockFunc_(d))
    );
    this.listeners_.push(Blockly.bindEvent_(b, "mouseover", d, d.addSelect));
    this.listeners_.push(Blockly.bindEvent_(b, "mouseout", d, d.removeSelect));
  }
  this.listeners_.push(
...
Blockly.Flyout.prototype.reflow = function () {
  for (
    var a,
      b = 0,
      c = this.CORNER_RADIUS,
      d = this.workspace_.getTopBlocks(!1),
      e = 0,
      f;
    (f = d[e]);
    e++
  )
    f.getSvgRoot(), (a = f.getHeightWidth()), (b = Math.max(b, a.width));
  b +=
    c +
    Blockly.BlockSvg.TAB_WIDTH +
    c / 2 +
  ...
  if (this.width_ != b) {
    for (e = 0; (f = d[e]); e++) {
      a = f.getHeightWidth();
      var g = f.getRelativeToSurfaceXY();
      if (this.RTL) {
        var h = b - c - Blockly.BlockSvg.TAB_WIDTH - g.x;
        f.moveBy(h, 0);
        g.x += h;
      }
      f.flyoutRect_ &&
        (f.flyoutRect_.setAttribute("width", a.width),
        f.flyoutRect_.setAttribute("height", a.height),
        f.flyoutRect_.setAttribute("x", this.RTL ? g.x - a.width : g.x),
        f.flyoutRect_.setAttribute("y", g.y));
    }
    this.width_ = b;
    Blockly.fireUiEvent(window, "resize");
  }
    ...
    : (Blockly.removeAllRanges(),
      Math.sqrt(
        Math.pow(a.clientX - Blockly.Flyout.startDownEvent_.clientX, 2) +
          Math.pow(a.clientY - Blockly.Flyout.startDownEvent_.clientY, 2)
      ) > Blockly.DRAG_RADIUS &&
        Blockly.Flyout.startFlyout_.createBlockFunc_(
...
Blockly.Toolbox.prototype.populate_ = function (a) {
  function b(a, e) {
    for (var d = 0, g; (g = a.childNodes[d]); d++)
      if (g.tagName)
...
Blockly.Toolbox.prototype.getRect = function () {
  if (this.workspace_.RTL) {
    var a = Blockly.svgSize(this.workspace_.options.svg);
...
Blockly.Css.setCursor = function (a) {
  if (Blockly.Css.currentCursor_ != a) {
    ...
    var b = a == Blockly.Css.Cursor.OPEN ? "8 5" : "7 3";
    b = "url(" + Blockly.Css.mediaPath_ + "/" + a + ".cur) " + b + ", auto";
...
Blockly.parseOptions_ = function (a) {
  ...
  if (g) {
    ...
    (h = Blockly.parseToolboxTree_(a.toolbox)),
  ...
  void 0 === n && (n = !0);
  var l = a.grid || {};
  l.spacing = l.spacing ? parseFloat(l.spacing) : 0;
  l.colour || (l.colour = "#888");
  l.length = l.length ? parseFloat(l.length) : 1;
  l.snap = 0 < l.spacing && !!l.snap;
  ...
  return {
    ...
    gridOptions: l,
    enableRealtime: r,
    realtimeOptions: r ? a.realtimeOptions : void 0,
  };
};
Blockly.createDom_ = function (a, b) {
  ...
  var e = Blockly.createSvgElement("filter", { id: "blocklyEmboss" }, d);
  Blockly.createSvgElement(
    "feGaussianBlur",
    { in: "SourceAlpha", stdDeviation: 1, result: "blur" },
    e
  );
  var f = Blockly.createSvgElement(
    "feSpecularLighting",
    {
      in: "blur",
      surfaceScale: 1,
      ...
      if (0 == Blockly.dragMode_) {
        ...
        if (
          ...
          for (var g = c.getTopBlocks(!1), h = 0, k; (k = g[h]); h++) {
            ...
            0 < l && k.moveBy(l, 0);
            l = e + a.viewWidth - 25 - m.x + (b.RTL ? n.width : 0);
            0 > l && k.moveBy(l, 0);
          }
      }
    });
...
Blockly.fireUiEventNow = function (a, b) {
  var c;
  if ((c = Blockly.fireUiEvent.DB_[b])) {
    var d = c.indexOf(a);
    -1 != d && c.splice(d, 1);
  }
...
Blockly.getMainWorkspaceMetrics_ = function () {
  ...
  var c = a.height - Blockly.Scrollbar.scrollbarThickness;
  try {
  ...
  if (this.scrollbar) {
    var e = this.RTL ? Blockly.Scrollbar.scrollbarThickness : 0;
    var f = this.RTL ? 0 : Blockly.Scrollbar.scrollbarThickness;
    e = Math.min(d.x - b / 2, d.x + d.width - b - e + 5);
  ...
  } else (e = d.x), (b = e + d.width), (f = d.y), (d = f + d.height);
  c = 0;
  !this.RTL && this.toolbox_ && (c = this.toolbox_.width);
  return {
    viewHeight: a.height,
    viewWidth: a.width,
    contentHeight: d - f,
