...
Blockly.Arduino.grove_temporature_sensor = function () {
  ...
  Blockly.Arduino.setups_["setup_output_" + dropdown_pin1] =
    "pinMode(" + dropdown_pin1 + ", OUTPUT);";
  Blockly.Arduino.setups_["setup_output_" + dropdown_pin2] =
    "pinMode(" + dropdown_pin2 + ", INPUT);";
...
Blockly.Arduino.grove_motor_shield = function () {
  ...
  var leftSpeed = Blockly.Arduino.valueToCode(
      this,
      "a",
      Blockly.Arduino.ORDER_ATOMIC
    ),
    rightSpeed = Blockly.Arduino.valueToCode(
      this,
      "b",
      Blockly.Arduino.ORDER_ATOMIC
    );
  Blockly.Arduino.setups_.setup_motor =
    "pinMode(12,OUTPUT);//I1\n  pinMode(13,OUTPUT);//I2\n  ";
  Blockly.Arduino.definitions_.define_motor_change =
    "void change_motor_state(int state, int leftSpeed, int rightSpeed){\n	switch(state)\n	{\n        case 0:\n        digitalWrite(12,HIGH);\n        digitalWrite(13,LOW);\n        break;\n        case 1:\n        digitalWrite(12,HIGH);\n        digitalWrite(13,HIGH);\n        break;\n        case 2:\n        digitalWrite(12,LOW);\n        digitalWrite(13,LOW);\n        break;\n        case 3:\n        digitalWrite(12,LOW);\n        digitalWrite(13,HIGH);\n        break;\n        case 4:\n        digitalWrite(12,HIGH);\n        digitalWrite(13,LOW);\n        analogWrite(10,0);\n        analogWrite(11,0);\n        return;\n        }\n    analogWrite(10,leftSpeed);\n    analogWrite(11,rightSpeed);\n}\n";
  var code = "";
...
Blockly.Arduino.grove_thumb_joystick = function () {
  ...
  return [
    "analogRead(" +
      ("y" === this.getFieldValue("AXIS") ? _get_next_pin(a) : a) +
      ")",
    Blockly.Arduino.ORDER_ATOMIC,
  ];
};
...
Blockly.Arduino.m_custom = function () {
  var a = Blockly.Arduino.valueToCode(this, "a", Blockly.Arduino.ORDER_ATOMIC),
    b = Blockly.Arduino.valueToCode(this, "b", Blockly.Arduino.ORDER_ATOMIC);
...
Blockly.Arduino.grove_lcd = function () {
  var value_a = Blockly.Arduino.valueToCode(
    this,
    "string",
    Blockly.Arduino.ORDER_ATOMIC
  );
  ...
  "  lcd.print("+value_a+");\n";*/
  var code = "";
  Blockly.Arduino.definitions_["grove_lcddef"] =
    "#include <Wire.h>\n" + '#include "rgb_lcd.h"\n\n' + "rgb_lcd lcd;\n";
  code = "lcd.begin(16, 2);\n" + "  lcd.print(" + value_a + ");\n";
...
Blockly.Arduino.grove_piezo_buzzer = function () {
  ...
  Blockly.Arduino.setups_["setup_piezo_buzzer_" + dropdown_pin] =
