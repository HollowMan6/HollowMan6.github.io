...
//Blockly.Blocks.grove_motor_shield={helpUrl:"http://www.seeedstudio.com/wiki/Motor_Shield",init:function(){this.setColour(190);this.appendDummyInput().appendField("\u7535\u673a").appendField(new Blockly.FieldDropdown([["\u505c\u6b62","stop"],["\u524d\u8fdb","forward"],["\u53f3\u8f6c","right"],["\u5de6\u8f6c","left"],["\u540e\u9000","backward"]]),"DIRECTION");this.setPreviousStatement(!0,null);this.setNextStatement(!0,null);this.setTooltip("Drive two brushed DC motors")}};
