...
Blockly.Blocks.inout_analog_write = {
  ...
  init: function () {
    this.setColour(190);
    this.appendDummyInput()
      .appendField("\u6a21\u62df\u4fe1\u53f7\u5199\u5165 Pin#")
      .appendField(
        new Blockly.FieldDropdown(profile["default"].digital),
        "PIN"
      );
    this.appendValueInput("NUM", "Number").appendField("值").setCheck("Number");
    this.setInputsInline(!0);
    this.setPreviousStatement(!0, null);
    this.setNextStatement(!0, null);
    ...
    this.appendDummyInput()
      ...
      .appendField(
        new Blockly.FieldImage(
          "http://www.seeedstudio.com/depot/images/product/a991.jpg",
          64,
          64
        )
      )
...
Blockly.Blocks.serial_print = {
  ...
  init: function () {
    this.setColour(190);
    this.appendValueInput("CONTENT", "String").appendField(
      "\u4e32\u53e3\u6253\u5370"
    );
    this.setPreviousStatement(!0, null);
    this.setNextStatement(!0, null);
...
Blockly.Blocks.lists_create_with = {
  ...
  updateShape_: function () {
    ...
    if (this.getInput("EMPTY")) this.removeInput("EMPTY");
      ...
      for (a = 0; this.getInput("ADD" + a); ) this.removeInput("ADD" + a), a++;
...
Blockly.Blocks.controls_if = {
  init: function () {
    ...
    this.appendValueInput("IF0")
      .setCheck("Boolean")
      .appendField("\u5982\u679c");
    this.appendStatementInput("DO0").appendField("\u505a");
    this.setPreviousStatement(!0);
    this.setNextStatement(!0);
    this.setMutator(
  ...
  domToMutation: function (a) {
    ...
    for (a = 1; a <= this.elseifCount_; a++)
      this.appendValueInput("IF" + a)
        .setCheck("Boolean")
        .appendField("\u5426\u5219\u5982\u679c"),
        this.appendStatementInput("DO" + a).appendField("\u505a");
    this.elseCount_ &&
      this.appendStatementInput("ELSE").appendField("\u5176\u4ed6");
  },
  decompose: function (a) {
...
Blockly.Blocks.controls_if_elseif = {
  init: function () {
    this.setColour(Blockly.Blocks.logic.HUE);
    this.appendDummyInput().appendField("\u5426\u5219\u5982\u679c");
    this.setPreviousStatement(!0);
    this.setNextStatement(!0);
...
Blockly.Blocks.controls_if_else = {
  init: function () {
    this.setColour(Blockly.Blocks.logic.HUE);
    this.appendDummyInput().appendField("\u5176\u4ed6");
    this.setPreviousStatement(!0);
...
Blockly.Blocks.logic_null = {
  init: function () {
    ...
    this.setColour(Blockly.Blocks.logic.HUE);
    this.setOutput(!0);
    this.appendDummyInput().appendField("\u7a7a");
...
Blockly.Blocks.controls_for = {
  init: function () {
    this.jsonInit({
      message0: "循环%1从%2到%3步长%4",
      args0: [
        { type: "field_variable", name: "VAR", variable: null },
        { type: "input_value", name: "FROM", check: "Number", align: "LEFT" },
        { type: "input_value", name: "TO", check: "Number", align: "LEFT" },
        { type: "input_value", name: "BY", check: "Number", align: "LEFT" },
      ],
      inputsInline: !0,
      previousStatement: null,
      nextStatement: null,
...
Blockly.Blocks.procedures_callnoreturn = {
  ...
  setProcedureParameters: function (a, b) {
    ...
    if (b)
      if (goog.array.equals(this.arguments_, a)) this.quarkArguments_ = b;
        ...
        var d = this.rendered;
        this.rendered = !1;
        for (var e = this.arguments_.length - 1; 0 <= e; e--)
          if ((c = this.getInput("ARG" + e))) {
            var f = c.connection.targetConnection;
            this.quarkConnections_[this.quarkArguments_[e]] = f;
        ...
        if ((this.quarkArguments_ = b))
          for (e = 0; e < this.arguments_.length; e++) {
            c = this.getInput("ARG" + e);
            var g = this.quarkArguments_[e];
  ...
  renderArgs_: function () {
    for (var a, b = 0; b < this.arguments_.length; b++)
      (a = this.appendValueInput("ARG" + b)
        .setAlign(Blockly.ALIGN_RIGHT)
        .appendField(this.arguments_[b])),
        a.init();
...
Blockly.Blocks.grove_lcd = {
  init: function () {
    this.appendValueInput("string").setCheck(null).appendField("LCD显示屏");
...
Blockly.Blocks.button = {
  init: function () {
    this.appendValueInput("touch").setCheck(null).appendField("读取按钮 Pin#");
...
Blockly.Blocks.touch = {
  init: function () {
    this.appendValueInput("touch").setCheck(null).appendField("触摸按钮 Pin#");
    this.setOutput(true, null);
    this.setColour(20);
    this.setTooltip("");
    this.setHelpUrl("");
